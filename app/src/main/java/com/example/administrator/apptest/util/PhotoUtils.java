...
public class PhotoUtils {
    ...
    public static String uploadFile(String RequestURL) {
        File file = new File("/storage/sdcard1/out_photo/20170213174454.png");
        String result = null;
        String BOUNDARY = UUID.randomUUID().toString(); // 边界标识 随机生成
//        String BOUNDARY = "7d4a6d158c9"; // 边界标识 随机生成
...
//                FileInputStream is = context.openFileInput(file.getValue().getPath());
